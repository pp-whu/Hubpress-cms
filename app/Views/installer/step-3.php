...
<head>
    ...
    <title>Admin erstellen — HuberCMS</title>
...
<div class="installer-card">
    <div class="text-center mb-4">
        ...
        <p class="text-muted mt-1 small">Installationsassistent — Schritt 3 von 3</p>
    </div>
    ...
    <h5 class="fw-bold mb-1">Administrator erstellen</h5>
    <p class="text-muted small mb-4">Dein Konto für den Admin-Bereich.</p>
    ...
    <form method="POST" action="/install/process">
        ...
        <div class="row g-3">
            <div class="col-12">
                ...
                <input type="text" name="site_name" class="form-control" placeholder="Mein CMS" required>
            </div>
            <div class="col-12">
                <label class="form-label">Benutzername</label>
                <input type="text" name="admin_username" class="form-control"
                       placeholder="admin" pattern="[a-zA-Z0-9]+" minlength="3" required>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <input type="password" name="admin_password" class="form-control"
                       placeholder="Mindestens 8 Zeichen" minlength="8" autocomplete="new-password" required>
            </div>
        </div>

        <div class="d-flex gap-2 mt-4">
            <a href="/install/step/2" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-left me-1"></i> Zurück
            </a>
            <button type="submit" class="btn btn-primary flex-grow-1 fw-semibold">
                <i class="bi bi-rocket-takeoff me-1"></i> Installation abschließen
            </button>
        </div>
    </form>
</div>
